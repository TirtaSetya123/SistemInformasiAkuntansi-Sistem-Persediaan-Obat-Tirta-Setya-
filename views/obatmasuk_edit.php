?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_obatmasuk WHERE idmasuk ='$id'") or die ("SQL Edit error");
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="jumlah" value="<?=$data['jumlah']?>"class="form-control" id="inputEmail3" placeholder="Para Pihak">
                            </div>
                        </div>
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE tbl_obatmasuk SET nama_obat='$nama',jenis_obat='$jenis_obat',
    jumlah='$jumlah',tgl_exp='$tglexp' WHERE idmasuk ='$id'"; 
