        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php
                    $sql = "SELECT *FROM tbl_persediaanobat WHERE idx ='" . $_GET ['idx'] . "'";
                    ...
                    <table class="table table-bordered table-striped table-hover"> 
                        <tr>
                            <td width="200">Ruang Arsip</td> <td><?= $data['nama_obat'] ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Para Pihak</td> <td><?= $data['jenis_obat'] ?></td>
                        </tr>
                        <tr>
                            <td>Nomor Perkara</td> <td><?= $data['no_perkara'] ?></td>
                        </tr>
						<tr>
                            <td>Tanggal Masuk</td> <td><?= $data['tgl_exp'] ?></td>
                        </tr>
						<tr>
                ...
                <div class="panel-footer">
                    <a href="?page=persediaanobat&actions=tampil" class="btn btn-success btn-sm">
